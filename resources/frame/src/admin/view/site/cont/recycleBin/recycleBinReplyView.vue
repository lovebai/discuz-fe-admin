      ...
      <div class="recycle-bin-reply-table">
        ...
        >
          ...
          <div class="recycle-bin-reply-table__main" slot="main">
            <a class="recycle-bin-reply-table__main__cont-text" :href="'/thread/comment/' + items.postId + '?threadId='+ items.threadId" target="_blank" v-html="filterContent(items.content.text)"></a>
