      ...
      <div class="recycle-bin-table">
        ...
        >
          ...
          <div class="recycle-bin-table__main" slot="main">
            <a class="recycle-bin-table__main__cont-text" :href="'/thread/' + items.threadId" target="_blank" :style="{'display':(contentIndexes(items.content, 'video') ? 'inline':'block')}" v-html="filterContent(items.content.text)"></a>
