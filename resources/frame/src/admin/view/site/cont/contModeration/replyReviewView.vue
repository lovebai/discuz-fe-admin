      ...
      <div class="cont-review-table">
        ...
        >
          ...
          <div class="cont-review-table__main" slot="main">
            <a class="cont-review-table__main__cont-text" :href="'/thread/comment/' + items.postId + '?threadId='+ items.threadId" target="_blank" v-html="filterContent(items.content.text)"></a>
